            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area d-flex">
                        ...
                        <div class="service-content">
                            ...
                            <p>Patient can book appointment online.<br>Pay online and receive E-mail about time slot.</p>
                        </div>
                    </div>
                </div>
                <!-- Single Service Area -->
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area d-flex">
                        ...
                        <div class="service-content">
                            ...
                            <p>Ambulance will be send at your address.<br>Patient can book emergency room online.</p>
                        </div>
                    </div>
                </div>
                <!-- Single Service Area -->
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area d-flex">
                        ...
                        <div class="service-content">
                            ...
                            <p>We have best doctors and medical staff.<br>We provide all types of surgeries and diagnoses.</p>
                        </div>
                    </div>
                </div>
                <!-- Single Service Area -->
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area d-flex">
                        ...
                        <div class="service-content">
                            <h5>Laboratory And Pathology</h5>
                            	<p>Patient can book any type of test online.<br>
                            	Our staff will collect sample from your given address.<br>
                            	Report of test will be send on E-mail address.</p>
                        </div>
                    </div>
                </div>
                <!-- Single Service Area -->
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area d-flex">
                        ...
                        <div class="service-content">
                            <h5>Free Check Up Camps</h5>
                            <p>We conduct free dental check up camps every month.</p>
                        </div>
                    </div>
                </div>
                <!-- Single Service Area -->
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-service-area d-flex">
                        ...
                        <div class="service-content">
                            <h5>24x7 Open Medical Store</h5>
                            <p>Our diagnosed patients can get benefits of 15% off on medicines.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h2>We always put <br>our patients first</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-4">
                    <div class="single-benefits-area mb-50 text-right">
                        ...
                        <p>Our dentists treat patients with latest machines to ensure less pain during treatment.</p>
                    </div>
                    <div class="single-benefits-area mb-50 text-right">
                        <div class="single-benefits-title d-flex align-items-end row-reverse">
                            <i class="icon-hospital-bed-1"></i>
                            <h5>Quality Of Rooms</h5>
                        </div>
                        <p>Clean and Spacious AC rooms.<br>Quality of beds and equipments is best</p>
                    </div>
                    <div class="single-benefits-area mb-50 text-right">
                        <div class="single-benefits-title d-flex align-items-end row-reverse">
                        ...
                        <p>Canteen<br>Waiting areas<br>Free and Safe parking<br>Elevators and Ramps<br>Electricity Generators</p>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-benefits-area mb-50">
                        ...
                        <p>We have in house laboratory and pathology.<br>Ensuring accurate results.</p>
                    </div>
                    <div class="single-benefits-area mb-50">
                        <div class="single-benefits-title d-flex align-items-end">
                        ...
                        <p>Results of appropriate test will be send through E-mail.</p>
                    </div>
                    <div class="single-benefits-area mb-50">
                        <div class="single-benefits-title d-flex align-items-end">
